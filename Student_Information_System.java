...
public class Student_Information_System extends JFrame {
	...
	public Student_Information_System() {
		...
		add(pane).setBounds(20, 120, 409, 235);
		...
		table.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				...
				String section = model.getValueAt(row, 2).toString();
		...
		btnadd.addActionListener(e->{
			...
			try(FileWriter fw = new FileWriter ("Form.txt", true)){
		...
		btnupdate.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                ...
                model.setValueAt(txtcourse.getText(), selectedRow, 1);
                model.setValueAt(txtsection.getText(), selectedRow, 2);
                saveAllToFile(); 
            } else {
		...
		btndelete.addActionListener(e-> {
			...
			int confirm = JOptionPane.showConfirmDialog(this, "Are you sure?", "Delete Confirmation", JOptionPane.YES_NO_CANCEL_OPTION);
		...
		public void saveAllToFile() {
			try (FileWriter fw = new FileWriter("Form.txt");
		            ...
		            for (int i = 0; i < model.getRowCount(); i++) {
		                ...
		                String section = model.getValueAt(i, 2).toString();
		                pw.println(name + " # " + course + " # " + section);
		            }
		...
		public void refreshTable() {
			model.setRowCount(0);
			try (BufferedReader bw = new BufferedReader(new FileReader("Form.txt"))) {
				String line;
